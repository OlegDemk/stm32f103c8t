...
#define W25QFLASH_CS_SELECT       HAL_GPIO_WritePin(GPIOB, GPIO_PIN_1, GPIO_PIN_RESET);  //HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_RESET)
#define W25QFLASH_CS_UNSELECT     HAL_GPIO_WritePin(GPIOB, GPIO_PIN_1, GPIO_PIN_SET);  //HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_SET)
